...
import Modelo.Motor; // traer motor y lo utilizamos en actualizar
import Modelo.Rueda;
...
public class JFrame_Principal extends javax.swing.JFrame {
    ...
    Rueda objRueda = null; //en cbn rueda
    
    public JFrame_Principal() {
        initComponents();
       objVehiculo = new Vehiculo();
    }
public void Cargar_Datos_Motor(){
    ...
    private void btn_Actualizar_MotorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Actualizar_MotorActionPerformed
        ...
        objMotor.setPotencia((int)spn_Potencia_Motor.getValue());
    ...
    private void btn_CrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CrearActionPerformed
      ...
      /*  objVehiculo.setObjMotor(objMotor);
        objVehiculo.setObjRueda01(objRueda01);
        objVehiculo.setObjRueda02(objRueda02);
        objVehiculo.setObjRueda03(objRueda03);
        objVehiculo.setObjRueda04(objRueda04);*/
      objVehiculo = new Vehiculo(objMotor, objRueda01, objRueda02, objRueda03, objRueda04);
