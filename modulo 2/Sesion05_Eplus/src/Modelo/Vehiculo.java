...
public class Vehiculo {
    ...
    private Motor objMotor; // existe motor dentro gracias a esto
    private Rueda objRueda01, objRueda02, objRueda03, objRueda04;
    //Constructor
    public Vehiculo() {
        objMotor = new Motor();
        objRueda01 =  new Rueda();
        objRueda02 =  new Rueda();
        objRueda03 =  new Rueda();
        objRueda04 =  new Rueda();
        
               
    }
    public Vehiculo(String propietario,Motor objmotor,Rueda obRueda01,Rueda obRueda02,Rueda obRueda03,Rueda obRueda04) {
    this.propietario = propietario;
    
    }
    public Vehiculo( Motor objMotor, Rueda objRueda01, Rueda objRueda02, Rueda objRueda03, Rueda objRueda04) {
