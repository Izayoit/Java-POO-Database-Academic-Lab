...
public class JFrame_Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel10)
                            .addComponent(cbo_Afiliacion_Per))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
        ...
        txt_Mostrar_Info.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                txt_Mostrar_InfoMouseReleased(evt);
            }
        });
    ...
    private void btn_Registrar_VenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Registrar_VenActionPerformed
        String dni = txt_Dni_Ven.getText();
        String nombres = txt_Nombres_Ven.getText();
        String apellidos = txt_Apellidos_Ven.getText();
        double tasa_comision = Double.parseDouble(txt_Tasa_Comision_Ven.getText());
        double monto_vendido = Double.parseDouble(txt_Monto_Vendido_Ven.getText());
        EmpleadoVendedor dato = new EmpleadoVendedor(nombres, apellidos, dni, tasa_comision, monto_vendido);
    ...
    private void btn_Registrar_PerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Registrar_PerActionPerformed
        String dni = txt_Dni_Per.getText();
        String nombres = txt_Nombres_Per.getText();
        String apellidos = txt_Apellidos_Per.getText();
        double sueldo_base = Double.parseDouble(txt_Sueldo_Base_Per.getText());
        String afiliacion = cbo_Afiliacion_Per.getSelectedItem().toString();
        EmpleadoPermanente dato = new EmpleadoPermanente(sueldo_base, afiliacion, apellidos, nombres, apellidos, dni);
        objArreglo.Registrar(dato);
        objArreglo.Listar(tbl_Datos);
    ...
    private void txt_Mostrar_InfoMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txt_Mostrar_InfoMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_Mostrar_InfoMouseReleased
