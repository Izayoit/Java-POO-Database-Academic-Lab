...
import modelo.prenda_de_vestir;


public class JFrame_prenda_de_vestir extends javax.swing.JFrame {

    prenda_de_vestir objprenda ;
    public JFrame_prenda_de_vestir() {
        initComponents();
        objprenda =new prenda_de_vestir("blusa", "blanco", 54, "shalon");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_tipo, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(89, 89, 89)
    ...
    private void btn_consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_consultarActionPerformed
        int precio = objprenda.getPrecio();
        txt_precio.setText(precio+"");
        String tipo= objprenda.getTipo();
        txt_tipo.setText(tipo);
        String color= objprenda.getColor();
        txt_color.setText(color);
        String marca = objprenda.getMarca();
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        objprenda.setTipo(tipo);
        int precio = Integer.parseInt(txt_precio.getText());
        objprenda.setPrecio(precio);
         String color = txt_color.getText();
         objprenda.setColor(color);
         String marca = txt_marca.getText();
         objprenda.setMarca(marca);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_prenda_de_vestir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_prenda_de_vestir().setVisible(true);
            }
        });
    }
