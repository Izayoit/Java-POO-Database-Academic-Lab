...
public class Jdialog_usuario extends javax.swing.JFrame {

    private int Tipo_Ope = 0;
    private Usuarios Elemento;
    public Jdialog_usuario() {
        initComponents();
          Actualizar_Tabla();
  ...
  private void Estado_Controles(boolean estado) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txt_password, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
       Estado_Controles(false);
        ...
        switch (Tipo_Ope) {
            case 1:Elemento = new Usuarios();
                       Elemento.setNombre_usuario(nombre);
                       Elemento.setEmail_usuario(email);
                       Elemento.setPassword_usuario(password);
                       UsuarioDAO.Insertar(Elemento);
                break;
            case 2:  Elemento.setNombre_usuario(nombre);
                       Elemento.setEmail_usuario(email);
                       Elemento.setPassword_usuario(password);
    ...
    private void tbl_datosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_datosMouseClicked
     ...
     if(Elemento != null){
        txt_nombre.setText(Elemento.getNombre_usuario());
        txt_email.setText(Elemento.getEmail_usuario());
        txt_password.setText(Elemento.getPassword_usuario());
     }
     }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jdialog_usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Jdialog_usuario().setVisible(true);
            }
        });
    }
